...
contract MoodNftTest is Test {
    ...
    function testViewTokenURI() public {
        ...
        function testGetHappySvgToImageUri() public {
            vm.prank(USER);
        string memory retrievedHappySvgUri = moodNft.getHappySvgImageUri();
        assertEq(retrievedHappySvgUri, HAPPY_SVG_URI);
    }

        function testGetSadSvgToImageUri() public {
            vm.prank(USER);
        string memory retrievedSadSvgUri = moodNft.getSadSvgImageUri();
        assertEq(retrievedSadSvgUri, SAD_SVG_URI);
    }
